...
namespace SingletonLogger.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
            _logger = Log.CustomExceptionLogger;
        }

        //Overriding Controller Method To Log
        protected override void OnException(ExceptionContext filterContext)
        {
            _logger.LogException(filterContext.Exception.ToString());
            filterContext.ExceptionHandled = true; //Marking exception has been handled
